...
const skills = ['Python','C/C++', 'MySQL', 'HTML', 'CSS','Bootstrap', 'JavaScript','React','Node','Express','MongoDB','Tailwind css'];
const interests = ['Artificial Intelligence', 'Open Source Contributing', 'Learn New Programming Languages', 'Explore New Things', 'Playing Chess', 'Cricket'];
      ...
      <main className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <section className="bg-white p-6 rounded-lg shadow-md hover:shadow-xl transition-shadow duration-300">
            ...
            <p className="mb-4">Hello! I'm a passionate BCA graduate from Gujarat University, class of 2025. I have a been interest in web development and coding, and I love creating innovative solutions to real-world problems.</p>
