...
const projects = [
    ...
    },
    {
        image: comingsoon,
        title: 'IOT Project',
        description: 'This is IOT project from InfoLabz company (I done my internship there).',
        languages: ['C++'],
        projectLink: '#',
        codeLink: '#'
    },
...
const Portfolio = () => {
    ...
    return (
        <div name="Portfolio" className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 py-16">
            {/* Header */}
                ...
                {projects.map((project, index) => (
                    <div
                        ...
                        className={`timeline-item relative mb-20 md:mb-32 ${
                            visibleItems.has(index.toString()) ? 'animate-fadeInUp' : 'opacity-0'
                        }`}
                        data-index={index}
                        style={{
